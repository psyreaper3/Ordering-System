...
<head>
    ...
    <title>Pork Free Options Menu</title>
    ...
    <div class="loading-overlay">
     ...
     <script type="text/javascript">
        function confirmRedirect(page) {
            if (confirm("Heading to the Pork Menu will clear your current order. Are you sure you wish to proceed?")) {
    ...
    <div class="container mt-1">
        <div class="top_position">
            <div class="survey-container">
                <h4><a href="javascript:void(0);" onclick="confirmRedirect('pork')">PORK-FREE OPTIONS</a></h4>
            ...
            ";
                        ...
                        $itemsQuery = "SELECT 
                                    ...
                                    WHERE 
                                        ...
                                        AND product_classification != 'Pork' 
